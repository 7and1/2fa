...
export default function HomePage() {
  ...
  const sharePath = useMemo(() => {
    ...
    return locale === "en" ? `/${encodedSecret}` : `/${locale}/${encodedSecret}`;
  }, [locale, secret]);
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      toast({
        title: tCommon("error"),
        description:
          err instanceof Error ? err.message : t("qr.errors.scanFailed"),
        variant: "destructive",
      });
    }
  };
        ...
        <div className="max-w-2xl mx-auto animate-fade-in">
          ...
          <Card className="mt-6 bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700">
            <CardHeader>
              ...
              <CardDescription className="text-gray-300 text-base">
                Why your password alone is like leaving your front door wide
                open
              </CardDescription>
            </CardHeader>
            <CardContent className="prose prose-invert max-w-none">
              <div className="text-gray-300 space-y-6">
                <p className="text-lg leading-relaxed">
                  Here&apos;s the thing about passwords - they&apos;re basically
                  useless in 2024. I&apos;m not being dramatic. Let me show you
                  the numbers that should scare you, then I&apos;ll show you how
                  to fix it in literally 10 seconds.
                </p>
                ...
                <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
                  ...
                  <p className="mb-4">
                    Imagine your house has a door with a regular lock.
                    That&apos;s your password. Now imagine the lock changes its
                    combination every 30 seconds, and only you have the device
                    that tells you the new combination. That&apos;s 2FA.
                  </p>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Even if you type your password into a fake website, the
                        attacker still can&apos;t get in without your 2FA code.
                        And by the time they try to use it, it&apos;s expired.
                        (Google Research)
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-400">
                        Those credential-stuffing attacks where hackers try
                        stolen passwords from other breaches? 100% stopped by
                        2FA. Remember, the average employee has 146 exposed
                        credentials on the dark web. (SpyCloud 2024)
                      </p>
                    </div>
                    <div>
                      <h4 className="font-semibold text-white mb-2">
                      ...
                      <p className="text-sm text-gray-400">
                        Even sophisticated targeted attacks get blocked 66% of
                        the time with 2FA. Not perfect, but way better than 0%.
                        (Google)
                      </p>
                    </div>
                  </div>
                ...
                <div className="bg-gray-800/50 p-6 rounded-lg border border-gray-700">
                  ...
                  <p className="mb-4">
                    Your 6-digit code comes from an algorithm called HMAC-SHA1.
                    This is cryptographic-grade mathematics - the same math that
                    protects military communications.
                  </p>
                  <div className="bg-gray-900/50 p-4 rounded space-y-2 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>
                        Odds of guessing:{" "}
                        <strong className="text-white">1 in 1 million</strong>{" "}
                        every 30 seconds
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                ...
                <div className="bg-gradient-to-r from-green-900/30 to-blue-900/30 p-6 rounded-lg border border-green-700">
                  ...
                  <p className="text-xs text-gray-400 mt-4">
                    Technical note: We use SubtleCrypto Web API - the same
                    cryptographic engine your browser uses for HTTPS
                ...
                <div className="bg-gradient-to-r from-purple-900/30 to-pink-900/30 p-6 rounded-lg border border-purple-700">
                  ...
                  <div className="space-y-3">
                    <p className="text-lg text-gray-200">
                      ...
                      <strong className="text-white">10 seconds</strong>. Not
                      using it makes you{" "}
                      <strong className="text-white">
                        99.9% more vulnerable
                      </strong>{" "}
                    ...
                    <p className="text-gray-300">
                      ...
                      <strong className="text-yellow-400">
                        $43 billion worth of risk
                      </strong>{" "}
                      (2023 total ATO losses) every time you use just a
                      password.
                    </p>
                ...
                <div className="text-xs text-gray-500 pt-4 border-t border-gray-800">
                  <p className="font-semibold mb-2">{t("education.sources.title")}</p>
                  <p>
                    Microsoft Security Report 2025, Bitwarden 2FA Survey 2024,
                    Sift Global Network 2024, Proofpoint Research 2024, AARP &
                    Javelin Study 2024, IBM Data Breach Report 2024, Google
                    Security Blog 2024, SpyCloud Research 2024
                  </p>
                </div>
              </div>
            </CardContent>
